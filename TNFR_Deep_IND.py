# -*- coding: utf-8 -*-
"""Umar_deep_IND_class_DLumar.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PddVyPc_Svx8WvYhrNltLA4eCOzE99vf
"""
...
df=pd.read_csv('/content/cdhit-membrane_vesicular (1).csv')
df.values
...
def train_evaluate_rnn(X_train, y_train, X_test, y_test, epochs=100, batch_size=10):
    ...
    # Define the model
    rnn = Sequential()
    rnn.add(SimpleRNN(64, return_sequences=True, input_shape=(timestamp, 153)))
    rnn.add(Dropout(0.5))
...
def train_evaluate_lstm(X_train, y_train, X_test, y_test, epochs=100, batch_size=10):
    ...
    # Define the model
    lstm = Sequential()
    lstm.add(LSTM(64, return_sequences=True, input_shape=(timestamp, 153)))
...
def train_evaluate_gru(X_train, y_train, X_test, y_test, epochs=100, batch_size=10):
    ...
    gru_model.add(GRU(64, return_sequences=True, input_shape=(timestamp, 153)))
...
def train_evaluate_bilstm(X_train, y_train, X_test, y_test, epochs=100, batch_size=10):
    ...
    bilstm_model.add(Bidirectional(LSTM(64, return_sequences=True), input_shape=(timestamp, 153)))
